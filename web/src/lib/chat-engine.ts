 ...
 * replies. Used by both web ContactSupportScreen and mobile contact.tsx.
 */
...
const TOPICS: TopicRule[] = [
  ...
  },
  {
    ...
    responses: [
      ...
      "I've flagged this for our team. In the meantime, try refreshing the page or closing and reopening the app. If the issue persists, use the Report a Problem form for faster tracking.",
      "Thanks for reporting that. Our team monitors bug reports closely and usually pushes fixes within 24-48 hours. Can you tell me what device/browser you're using?",
    ],
  },
  {
    patterns: [/account|profile|setting|password|email|login|sign.*in/i],
    responses: [
      "You can manage your account from the Profile page — update your name, email, notification preferences, and theme. You'll find it in the top nav.",
  ...
  },
  {
    ...
    responses: [
      ...
      "Theme preference is saved to your account, so it'll stay consistent whether you're on web or mobile.",
    ],
  },
  {
...
/** Track which response index to use per topic to avoid repeats */
